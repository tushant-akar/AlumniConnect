...
class UsersFragment : Fragment() {
                        ...
                        override fun onItemClick(position: Int) {
                            val fragment = UserVerificationFragment().apply {
                                arguments = Bundle().apply {
                                    ...
                                    putBoolean("isStudent", usersList[position].isStudent)
                                    putBoolean("isAlumni", usersList[position].isAlumni)
                                    putBoolean("isVerified", usersList[position].isVerified)
                                }
                            }

                            navigateToFragmentWithBackStack(fragment)
                        }
                    })
    ...
    private fun navigateToFragmentWithBackStack(fragment: Fragment) {
