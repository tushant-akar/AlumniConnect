package com.example.studentportal.alumni
...
import com.example.studentportal.fragments.PaymentFragment
...
class AlumniDashboardActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bottomNavigationView = findViewById(R.id.bottom_navigation_view_alumni)
    ...
    private fun loadFragment(fragment: Fragment) {
        ...
        transaction.replace(R.id.nav_fragment_alumni, fragment)
